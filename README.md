# AuraManager Public Distribution

Public distribution repository for the [AuraManager](https://www.aurababa.com) CLI.
...
To provision a self-host server, you need access to the private source repository. Contact the maintainer for access.
